...
from app.models import User, Items  # Make sure to import your User model
...
def init_app(app:Flask):
    ...
    def edit_item():
        serial_number = request.form.get('editSerialNumber')  # Updated to use get() method
        item_name = request.form.get('editItemName')  # Updated to use get() method
        quantity = request.form.get('editQuantity')  # Updated to use get() method
        category = request.form.get('editCategory')  # Updated to use get() method
        bill_number = request.form.get('editBillNumber')  # Updated to use get() method
        date_of_purchase = request.form.get('editDateOfPurchase')  # Updated to use get() method
        warranty = request.form.get('editWarranty')  # Updated to use get() method

        if serial_number is None:
            flash('Serial number is required.', 'danger')
            return redirect(url_for('admin'))

        item = db.session.get(Items, serial_number)
        if item:
